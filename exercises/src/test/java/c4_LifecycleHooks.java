...
public class c4_LifecycleHooks extends LifecycleHooksBase {
    ...
    public void no_subscription_no_gains() {
        ...
        Flux<Integer> temperatureFlux = room_temperature_service().doOnSubscribe((s) -> hooksTriggered.add("subscribe"))
    ...
    public void atomic_counter() {
        ...
        Flux<Integer> temperatureFlux = room_temperature_service().doOnEach(s->{
            if(s.hasValue())
    ...
    public void one_to_catch_them_all() {
        ...
        Flux<Integer> temperatureFlux = room_temperature_service().doFinally((s)->hooksTriggeredCounter.incrementAndGet())
