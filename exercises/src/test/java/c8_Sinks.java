...
public class c8_Sinks extends SinksBase {
    ...
    public void single_shooter() {
        ...
        */
        ...
        /*Mono<Boolean> operationCompleted = Mono.fromCallable(()->{
            submitOperation(() -> {
    ...
    public void emit_failure() {
        ...
        for (int i = 1; i <= 50; i++) {
            int finalI = i;
            new Thread(() -> sink.emitNext(finalI,(signal,emitResult)-> emitResult.equals(Sinks.EmitResult.FAIL_NON_SERIALIZED))).start();
        }
